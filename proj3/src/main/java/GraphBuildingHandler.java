...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Way activeWay = null;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeWay.addNodeOnWay(g.getNode(nodeID));
            ...
            activeNode.setNodeName(nodeName);
        }
    }
...
//            System.out.println("Finishing a way...");
            if (activeWay.isValid()) {
                for (int i = 0; i < activeWay.nodesOnWay.size() - 1; i++) {
                    GraphDB.Node node1 = activeWay.nodesOnWay.get(i);
                    GraphDB.Node node2 = activeWay.nodesOnWay.get(i + 1);
                    node1.addAdjNode(node2.id);
                    node2.addAdjNode(node1.id);
                }
            }
        }
    }
